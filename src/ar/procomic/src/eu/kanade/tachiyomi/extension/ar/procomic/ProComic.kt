...
class ProComic : HttpSource() {
    ...
    override val client: OkHttpClient = network.client.newBuilder()
        ...
        .addInterceptor { chain ->
            ...
            // التعامل مع إعادة بناء الصور داخل الـ Interceptor لمنع تضارب الـ fetchImage النهائي
            if (request.url.toString().contains("/reconstruct/page_")) {
                val base64 = request.url.queryParameter("data") ?: throw Exception("No map data")
    ...
    override fun imageRequest(page: Page): Request {
        ...
        if (data != null && data.startsWith("DECRYPTED_MAP:")) {
            ...
            val fakeUrl = "$baseUrl/reconstruct/page_${page.index}.jpg?data=$base64"
